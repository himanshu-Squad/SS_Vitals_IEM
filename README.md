...
# Changes made 
## LiveVideo is running on this branch
### For Running Live Video - python main.py --method=POS --livefeed
### For passing pre-recorded video - python main.py --method=POS --video_path=/path/to/the/video
